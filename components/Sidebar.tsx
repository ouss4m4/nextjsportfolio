    ...
    <div className="text-whitetxt font-lines">
      ...
      <div className="flex justify-around w-9/12 mx-auto my-5 md:w-full">
        <a href="https://github.com/ouss4m4" target="_blank" rel="noreferrer">
          <AiFillGithub className="w-8 h-8 cursor-pointer dark:text-whitetxt" />
        </a>
        <a
          ...
          rel="noreferrer"
        >
          <AiFillLinkedin className="w-8 h-8 text-blue-800 cursor-pointer dark:text-whitetxt" />
        </a>
        <a href="https://twitter.com/0uss4m4" target="_blank" rel="noreferrer">
          <AiFillTwitterCircle className="w-8 h-8 text-blue-500 cursor-pointer dark:text-whitetxt" />
        </a>
      </div>
      {/* Address */}
      <div
      ...
      {/* contact*/}
      <button
        className="w-8/12 px-5 py-2 my-2 rounded-full text-whitetxt bg-gradient-to-r from-green-400 to-blue-400 focus:outline-none"
